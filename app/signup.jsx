...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: "bold", marginBottom: 30, textAlign: "center", color: "#296a95ff" },
  input: {
    width: "90%",
    padding: 14,
    borderWidth: 1,
  ...
  link: { color: "#1b529aff", marginTop: 15, textDecorationLine: "underline", fontSize: 15 },
});
